...
angular.module('my-angular-components').run(['$templateCache', function($templateCache) {$templateCache.put('app/Examples/login.html','<button class="btn btn-primary" ng-click=vm.authService.login()>Log In</button><div ng-if=isAuthenticated><p>Thank you for logging in!</p><button ng-click=vm.authService.logout()>Log Out</button></div>');
$templateCache.put('app/Components/Reports/reportViewerTemplate.html','<div ej-reportviewer id=container e-reportserviceurl={{vm.reportUrl}} e-processingmode={{vm.processingMode}} e-reportpath={{vm.report}} style=height:680px></div>');
...
$templateCache.put('app/Examples/Layout/adminLayoutExampleTemplate.html','<admin-layout title=Admidn theme=success side-menu-items=vm.sideMenuItems user-menu-items=vm.userMenuItems alert-menu-items=vm.alertMenuItems , footer-links=vm.footerLinks user-name={{vm.userName}}></admin-layout>');
...
$templateCache.put('app/Components/Layout/AdminLayout/AdminLayoutCore/adminLayoutTemplate.html','<div id=page-wrapper ng-cloak ng-class=vm.getState()><div id=sidebar-wrapper><admin-side-menu colapsed=vm.colapsed footer-links=vm.footerLinks side-menu-items=vm.sideMenuItems></admin-side-menu></div><div id=content-wrapper><div class=page-content><admin-header-bar title=Timebanking alert-menu-items=vm.alertMenuItems user-menu-items=vm.userMenuItems user-name={{vm.userName}}></admin-header-bar><div ui-view></div></div></div></div>');
$templateCache.put('app/Components/Layout/AdminLayout/Header/AlertsDropDown/alertsDropDownMenuTemplate.html','<div class="item dropdown" uib-dropdown><a href=# class=dropdown-toggle uib-dropdown-toggle><i class="fa fa-bell"></i></a><ul class="dropdown-menu dropdown-menu-right"><li class=dropdown-header>Alerts</li><li class=divider></li><li ng-repeat="item in vm.menuItems"><div class=row><i class="fa fa-{{item.icon}} col-md-3" style=margin:0></i> <a ui-sref={{item.state}} class=col-md-8>{{item.linkText}}</a></div></li></ul></div>');
$templateCache.put('app/Components/Layout/AdminLayout/Header/HeaderBar/headerBarTemplate.html','<div class="row header"><div class=col-xs-12><div class="user pull-right"><div class="item dropdown" uib-dropdown><user-options-drop-down-menu menu-items=vm.userMenuItems user-name={{vm.userName}}></user-options-drop-down-menu></div><div class="item dropdown" uib-dropdown><alerts-drop-down-menu menu-items=vm.alertMenuItems></alerts-drop-down-menu></div></div><div class=meta><div class=page>{{vm.title}}</div></div></div></div>');
$templateCache.put('app/Components/Layout/AdminLayout/Header/UserOptionsDropDown/userOptionsDropDownMenuTemplate.html','<div class="item dropdown" uib-dropdown><a href=# class=dropdown-toggle uib-dropdown-toggle><i class="fa fa-user"></i></a><ul class="dropdown-menu dropdown-menu-right"><li class=dropdown-header>{{vm.userName}}</li><li class=divider></li><li ng-repeat="item in vm.menuItems"><div class=row><i class="fa fa-{{item.icon}} col-md-3" style=margin:0></i> <a ui-sref={{item.state}} class=col-md-8>{{item.linkText}}</a></div></li></ul></div>');
$templateCache.put('app/Components/Layout/AdminLayout/SideMenu/SideMenu/sideMenuTemplate.html','<ul class=sidebar><li class=sidebar-main><a ng-click=vm.toggleSidebar()>Dashboard <span class="fa fa-switch"></span></a></li><admin-side-menu-items menu-items=vm.sideMenuItems></admin-side-menu-items></ul><side-menu-footer links=vm.footerLinks></side-menu-footer>');
$templateCache.put('app/Components/Layout/AdminLayout/SideMenu/SideMenuFooter/sideFooterTemplate.html','<div class=sidebar-footer><div class=col-xs-4><a state=vm.links[0].state>{{vm.links[0].linkText}}</a></div><div class=col-xs-4><a state=vm.links[1].state>{{vm.links[1].linkText}}</a></div><div class=col-xs-4><a state=vm.links[2].state>{{vm.links[2].linkText}}</a></div></div>');
$templateCache.put('app/Components/Layout/AdminLayout/SideMenu/SideMenuItems/sideMenuItemsTemplate.html','<li class=sidebar-list ng-repeat="item in vm.menuItems"><a ui-sref={{item.state}} ng-if=vm.isAuthenticated>{{item.linkText}} <span class="menu-icon fa fa-{{item.icon}}"></span></a></li>');}]);